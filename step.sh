...
appcenter test run uitest --app "rashmi.padhi-01/Petco_QA_iOS" --devices "rashmi.padhi-01/apple-iphone-7-plus" --app-path /Users/rashmi.padhi/Desktop/IPA/Petco.iOS.ipa  --fixture Petco.UITests.Cart\(iOS\).VerifyCartFlowSecureCheckOutForgotPasswordwithOutRepeatDelivery --test-series "master" --locale "en_US" --build-dir "/Users/rashmi.padhi/Documents/Srini_AutomationBranch/Petco.UITests/bin/Debug"
#
# --- Exit codes:
